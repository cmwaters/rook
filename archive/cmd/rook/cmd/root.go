...
import (
	...
	"github.com/cmwaters/rook/app/params"
...
appOpts servertypes.AppOptions) (servertypes.ExportedApp, error) {
	...
	var a *app.RookApp
	if height != -1 {
		a = app.New(appName, logger, db, traceStore, false, map[int64]bool{}, "", uint(1), appOpts, encCfg)

		if err := a.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		a = app.New(appName, logger, db, traceStore, true, map[int64]bool{}, "", uint(1), appOpts, encCfg)
	}
