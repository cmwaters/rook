...
func (*MsgMove) Descriptor() ([]byte, []int) {
	return fileDescriptor_0191934203f9d4c2, []int{0}
}
...
func (m *MsgMove) GetQuantity() string {
	if m != nil {
		return m.Quantity
	}
	return ""
...
func init() {
	proto.RegisterType((*MsgMove)(nil), "rook.rook.v1beta1.MsgMove")
}

func init() { proto.RegisterFile("rook/v1beta/move.proto", fileDescriptor_0191934203f9d4c2) }

var fileDescriptor_0191934203f9d4c2 = []byte{
	// 259 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2b, 0xca, 0xcf, 0xcf,
	0xd6, 0x2f, 0x33, 0x4c, 0x4a, 0x2d, 0x49, 0xd4, 0xcf, 0xcd, 0x2f, 0x4b, 0xd5, 0x2b, 0x28, 0xca,
	0x2f, 0xc9, 0x17, 0x12, 0x04, 0x89, 0xeb, 0x81, 0x09, 0x88, 0xa4, 0xa1, 0x94, 0x48, 0x7a, 0x7e,
	0x7a, 0x3e, 0x58, 0x56, 0x1f, 0xc4, 0x82, 0x28, 0x54, 0x5a, 0xc6, 0xc8, 0xc5, 0xee, 0x5b, 0x9c,
	0xee, 0x9b, 0x5f, 0x96, 0x2a, 0xc4, 0xc7, 0xc5, 0x94, 0x99, 0x22, 0xc1, 0xa8, 0xc0, 0xa8, 0xc1,
	...
	0x4a, 0x2d, 0x2e, 0x0e, 0x82, 0x99, 0x20, 0x24, 0xc5, 0xc5, 0x51, 0x58, 0x9a, 0x98, 0x57, 0x92,
	0x59, 0x52, 0x29, 0xc1, 0x0c, 0xb6, 0x02, 0xce, 0x17, 0x12, 0xe2, 0x62, 0x49, 0x2b, 0xca, 0xcf,
	0x95, 0x60, 0x01, 0x8b, 0x83, 0xd9, 0x20, 0xc7, 0x94, 0xe4, 0x4b, 0xb0, 0x42, 0x1c, 0x53, 0x92,
	0xef, 0x64, 0x7f, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e,
	0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7, 0x72, 0x0c, 0x51, 0xaa, 0xc8, 0x2e,
	0xca, 0x2d, 0x4f, 0x2c, 0x49, 0x2d, 0x2a, 0xd6, 0x07, 0x87, 0x4b, 0x05, 0x84, 0x02, 0x3b, 0x2a,
	0x89, 0x0d, 0xec, 0x61, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xa9, 0x01, 0xb2, 0x0d, 0x33,
	0x01, 0x00, 0x00,
}
...
func (m *MsgMove) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.To) > 0 {
		i -= len(m.To)
		copy(dAtA[i:], m.To)
		i = encodeVarintMove(dAtA, i, uint64(len(m.To)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.From) > 0 {
		i -= len(m.From)
		copy(dAtA[i:], m.From)
		i = encodeVarintMove(dAtA, i, uint64(len(m.From)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Quantity) > 0 {
		...
		i = encodeVarintMove(dAtA, i, uint64(len(m.Quantity)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Creator) > 0 {
